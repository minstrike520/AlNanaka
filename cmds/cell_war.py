...
from funcs.cellwar.core.runtime import Runtime
...
class CellWar(Cog):
    ...
    @commands.command()
    async def start_cw(self, ctx: Context):
        print("Command called: _start_cw")
        recv = Receiver(self.bot, ctx).add(exit_cond, exit_callback)
